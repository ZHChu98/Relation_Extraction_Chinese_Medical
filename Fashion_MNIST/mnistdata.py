...
def load_mnist_data(data_dir):
    ...
    local_train_images_file = ungzip(train_images_file, data_dir)
    train_labels_file = 'train-labels-idx1-ubyte.gz'
    local_train_labels_file = ungzip(train_labels_file, data_dir)
    test_images_file = 't10k-images-idx3-ubyte.gz'
    local_test_images_file = ungzip(test_images_file, data_dir)
    test_labels_file = 't10k-labels-idx1-ubyte.gz'
    local_test_labels_file = ungzip(test_labels_file, data_dir)
    return local_train_images_file, local_train_labels_file, local_test_images_file, local_test_labels_file

def ungzip(filename, work_directory):
    if filename[-3:] == ".gz":
